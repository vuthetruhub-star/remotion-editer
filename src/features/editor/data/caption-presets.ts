// caption-presets.ts — data (không phải logic). Tách ra khỏi
// control-item/floating-controls/caption-preset-picker.tsx vì đây là danh
// sách preset tĩnh (~4200 dòng), không phải component logic — để file
// component còn lại dễ đọc/review hơn.
import type { ICaptionsControlProps } from "../control-item/floating-controls/caption-preset-picker";
